...
{
    // 获取修饰符
    QKeyCombination keyCombination = keySequence[0];  // 使用 QKeyCombination 代替 int
    int modifiers = int(keyCombination.keyboardModifiers());  // 获取修饰键
    int key = int(keyCombination.key());  // 获取具体按键
